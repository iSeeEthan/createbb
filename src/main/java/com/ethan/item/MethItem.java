...
import com.ethan.register.CBBBlocks;
...
public class MethItem extends Item {
    ...
    public @NotNull InteractionResult useOn(UseOnContext pContext) {
        ...
        Block newBlock = (pContext.getItemInHand().getItem() instanceof MethItem.Blue) ? CBBBlocks.BLUE_METH_TRAY.get() : CBBBlocks.WHITE_METH_TRAY.get();
